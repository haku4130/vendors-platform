...
import { usersUploadAvatar } from '~/generated/api';
...
const { currentAvatar = undefined } = defineProps<{
...
async function onSubmit(event: FormSubmitEvent<schema>) {
  ...
  const res = await usersUploadAvatar({
    body: { file: event.data.avatar },
  });
          ...
          <NuxtImg
            :src="
              state.avatar
                ...
                : currentAvatar || '/placeholder-avatar.png'
            "
            class="w-full rounded-lg m-0 border"
          />
