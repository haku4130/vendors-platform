...
export type UsersUploadAvatarError =
  UsersUploadAvatarErrors[keyof UsersUploadAvatarErrors];
...
export type UsersUploadAvatarResponse =
  UsersUploadAvatarResponses[keyof UsersUploadAvatarResponses];
...
export type FeedbackGetFeedbackError =
  FeedbackGetFeedbackErrors[keyof FeedbackGetFeedbackErrors];
...
export type FeedbackGetFeedbackResponse =
  FeedbackGetFeedbackResponses[keyof FeedbackGetFeedbackResponses];
...
export type FeedbackSubmitPlatformFeedbackError =
  FeedbackSubmitPlatformFeedbackErrors[keyof FeedbackSubmitPlatformFeedbackErrors];
...
export type FeedbackSubmitPlatformFeedbackResponse =
  FeedbackSubmitPlatformFeedbackResponses[keyof FeedbackSubmitPlatformFeedbackResponses];
...
export type VendorsSearchVendorsError =
  VendorsSearchVendorsErrors[keyof VendorsSearchVendorsErrors];
...
export type VendorsSearchVendorsResponse =
  VendorsSearchVendorsResponses[keyof VendorsSearchVendorsResponses];
...
export type VendorsGetMyVendorProfileResponse =
  VendorsGetMyVendorProfileResponses[keyof VendorsGetMyVendorProfileResponses];
...
export type VendorsCreateVendorProfileError =
  VendorsCreateVendorProfileErrors[keyof VendorsCreateVendorProfileErrors];
...
export type VendorsCreateVendorProfileResponse =
  VendorsCreateVendorProfileResponses[keyof VendorsCreateVendorProfileResponses];
...
export type VendorsGetAvailableProjectsForVendorError =
  VendorsGetAvailableProjectsForVendorErrors[keyof VendorsGetAvailableProjectsForVendorErrors];
...
export type VendorsGetAvailableProjectsForVendorResponse =
  VendorsGetAvailableProjectsForVendorResponses[keyof VendorsGetAvailableProjectsForVendorResponses];
...
export type VendorsGetVendorProfileError =
  VendorsGetVendorProfileErrors[keyof VendorsGetVendorProfileErrors];
...
export type VendorsGetVendorProfileResponse =
  VendorsGetVendorProfileResponses[keyof VendorsGetVendorProfileResponses];
...
export type VendorsGetIncomingRequestsForVendorError =
  VendorsGetIncomingRequestsForVendorErrors[keyof VendorsGetIncomingRequestsForVendorErrors];
...
export type VendorsGetIncomingRequestsForVendorResponse =
  VendorsGetIncomingRequestsForVendorResponses[keyof VendorsGetIncomingRequestsForVendorResponses];
...
export type VendorsGetMyProposalError =
  VendorsGetMyProposalErrors[keyof VendorsGetMyProposalErrors];

export type VendorsGetMyProposalResponses = {
  200: ProjectRequestPublicProjectFull;
};

export type VendorsGetMyProposalResponse =
  VendorsGetMyProposalResponses[keyof VendorsGetMyProposalResponses];
...
export type VendorsGetMyProposalsError =
  VendorsGetMyProposalsErrors[keyof VendorsGetMyProposalsErrors];

export type VendorsGetMyProposalsResponses = {
  200: PaginatedProjectRequestsPublicProjectFull;
};

export type VendorsGetMyProposalsResponse =
  VendorsGetMyProposalsResponses[keyof VendorsGetMyProposalsResponses];
...
export type VendorsGetMyAcceptedProjectsError =
  VendorsGetMyAcceptedProjectsErrors[keyof VendorsGetMyAcceptedProjectsErrors];
...
export type VendorsGetMyAcceptedProjectsResponse =
  VendorsGetMyAcceptedProjectsResponses[keyof VendorsGetMyAcceptedProjectsResponses];
...
export type VendorsGetMyArchivedProjectsError =
  VendorsGetMyArchivedProjectsErrors[keyof VendorsGetMyArchivedProjectsErrors];
...
export type VendorsGetMyArchivedProjectsResponse =
  VendorsGetMyArchivedProjectsResponses[keyof VendorsGetMyArchivedProjectsResponses];
...
export type CatalogListCategoriesResponse =
  CatalogListCategoriesResponses[keyof CatalogListCategoriesResponses];
...
export type CatalogCreateCategoryError =
  CatalogCreateCategoryErrors[keyof CatalogCreateCategoryErrors];
...
export type CatalogCreateCategoryResponse =
  CatalogCreateCategoryResponses[keyof CatalogCreateCategoryResponses];
...
export type CatalogUpdateCategoryError =
  CatalogUpdateCategoryErrors[keyof CatalogUpdateCategoryErrors];
...
export type CatalogUpdateCategoryResponse =
  CatalogUpdateCategoryResponses[keyof CatalogUpdateCategoryResponses];
...
export type CatalogCreateServiceError =
  CatalogCreateServiceErrors[keyof CatalogCreateServiceErrors];
...
export type CatalogCreateServiceResponse =
  CatalogCreateServiceResponses[keyof CatalogCreateServiceResponses];
...
export type CatalogDeleteServiceError =
  CatalogDeleteServiceErrors[keyof CatalogDeleteServiceErrors];
...
export type CatalogDeleteServiceResponse =
  CatalogDeleteServiceResponses[keyof CatalogDeleteServiceResponses];
...
export type CatalogUpdateServiceError =
  CatalogUpdateServiceErrors[keyof CatalogUpdateServiceErrors];
...
export type CatalogUpdateServiceResponse =
  CatalogUpdateServiceResponses[keyof CatalogUpdateServiceResponses];
...
export type ProjectsCreateNewProjectError =
  ProjectsCreateNewProjectErrors[keyof ProjectsCreateNewProjectErrors];
...
export type ProjectsCreateNewProjectResponse =
  ProjectsCreateNewProjectResponses[keyof ProjectsCreateNewProjectResponses];
...
export type ProjectsGetProjectDetailError =
  ProjectsGetProjectDetailErrors[keyof ProjectsGetProjectDetailErrors];
...
export type ProjectsGetProjectDetailResponse =
  ProjectsGetProjectDetailResponses[keyof ProjectsGetProjectDetailResponses];
...
export type ProjectsGetMatchingVendorsError =
  ProjectsGetMatchingVendorsErrors[keyof ProjectsGetMatchingVendorsErrors];
...
export type ProjectsGetMatchingVendorsResponse =
  ProjectsGetMatchingVendorsResponses[keyof ProjectsGetMatchingVendorsResponses];
...
export type ProjectsSendProjectRequestCompanyError =
  ProjectsSendProjectRequestCompanyErrors[keyof ProjectsSendProjectRequestCompanyErrors];
...
export type ProjectsSendProjectRequestCompanyResponse =
  ProjectsSendProjectRequestCompanyResponses[keyof ProjectsSendProjectRequestCompanyResponses];
...
export type ProjectsSendProjectRequestVendorError =
  ProjectsSendProjectRequestVendorErrors[keyof ProjectsSendProjectRequestVendorErrors];
...
export type ProjectsSendProjectRequestVendorResponse =
  ProjectsSendProjectRequestVendorResponses[keyof ProjectsSendProjectRequestVendorResponses];
...
export type ProjectsGetProjectRequestsError =
  ProjectsGetProjectRequestsErrors[keyof ProjectsGetProjectRequestsErrors];
...
export type ProjectsGetProjectRequestsResponse =
  ProjectsGetProjectRequestsResponses[keyof ProjectsGetProjectRequestsResponses];
...
export type RequestsGetRequestError =
  RequestsGetRequestErrors[keyof RequestsGetRequestErrors];

export type RequestsGetRequestResponses = {
  200: ProjectRequestPublicVendorFull;
};

export type RequestsGetRequestResponse =
  RequestsGetRequestResponses[keyof RequestsGetRequestResponses];
...
export type RequestsAcceptProjectError =
  RequestsAcceptProjectErrors[keyof RequestsAcceptProjectErrors];
...
export type RequestsAcceptProjectResponse =
  RequestsAcceptProjectResponses[keyof RequestsAcceptProjectResponses];
...
export type RequestsDeclineProjectError =
  RequestsDeclineProjectErrors[keyof RequestsDeclineProjectErrors];
...
export type RequestsDeclineProjectResponse =
  RequestsDeclineProjectResponses[keyof RequestsDeclineProjectResponses];
...
export type ReviewsGetReviewsForUserError =
  ReviewsGetReviewsForUserErrors[keyof ReviewsGetReviewsForUserErrors];
...
export type ReviewsGetReviewsForUserResponse =
  ReviewsGetReviewsForUserResponses[keyof ReviewsGetReviewsForUserResponses];
...
export type ReviewsGetReviewsForVendorError =
  ReviewsGetReviewsForVendorErrors[keyof ReviewsGetReviewsForVendorErrors];
...
export type ReviewsGetReviewsForVendorResponse =
  ReviewsGetReviewsForVendorResponses[keyof ReviewsGetReviewsForVendorResponses];
...
export type ReviewsGetMyReviewsError =
  ReviewsGetMyReviewsErrors[keyof ReviewsGetMyReviewsErrors];
...
export type ReviewsGetReviewsReceivedByMeError =
  ReviewsGetReviewsReceivedByMeErrors[keyof ReviewsGetReviewsReceivedByMeErrors];
...
export type ReviewsGetReviewsReceivedByMeResponse =
  ReviewsGetReviewsReceivedByMeResponses[keyof ReviewsGetReviewsReceivedByMeResponses];
...
export type ReviewsGetUsersToReviewResponse =
  ReviewsGetUsersToReviewResponses[keyof ReviewsGetUsersToReviewResponses];
...
export type ShortlistRemoveVendorFromShortlistError =
  ShortlistRemoveVendorFromShortlistErrors[keyof ShortlistRemoveVendorFromShortlistErrors];
...
export type ShortlistRemoveVendorFromShortlistResponse =
  ShortlistRemoveVendorFromShortlistResponses[keyof ShortlistRemoveVendorFromShortlistResponses];
...
export type ShortlistAddVendorToShortlistError =
  ShortlistAddVendorToShortlistErrors[keyof ShortlistAddVendorToShortlistErrors];
...
export type ShortlistAddVendorToShortlistResponse =
  ShortlistAddVendorToShortlistResponses[keyof ShortlistAddVendorToShortlistResponses];
...
export type ShortlistGetShortlistedVendorsError =
  ShortlistGetShortlistedVendorsErrors[keyof ShortlistGetShortlistedVendorsErrors];
...
export type ShortlistGetShortlistedVendorsResponse =
  ShortlistGetShortlistedVendorsResponses[keyof ShortlistGetShortlistedVendorsResponses];
